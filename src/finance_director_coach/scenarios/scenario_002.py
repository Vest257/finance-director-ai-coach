...
SCENARIO_002_PRESENTATION = (
    ...
    FinancialPackTable("Northstar commercial inputs", ("Input", "Value"), (("Reported annual revenue", "GBP 9.00m"), ("Standard price", "GBP 10.50m"), ("Direct cost-to-serve", "GBP 6.00m"), ("Target contribution margin", "45.0%"), ("Requested additional discount", "5.0%"), ("Contractual payment terms", "45 days"))),
    ...
    FinancialPackTable("Liquidity inputs", ("Input", "Value"), (("Cash", "GBP 3.80m"), ("Gross debt", "GBP 8.00m"), ("Undrawn RCF", "GBP 4.00m"), ("Board minimum operating cash", "GBP 3.50m"))),
    ...
    FinancialPackTable("Renew as proposed", ("Assumption", "Value"), (("Requested additional discount", "5.0%"), ("Annual revenue and cash reduction", "0.45"), ("Further receivable and unbilled-work build", "0.90"), ("Direct cost-to-serve base", "No immediate repair to the 6.00 base"))),
